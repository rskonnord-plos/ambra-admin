          ...
          <table width="100%">
            ...
            <#list flaggedComments as flaggedComment>
              <#if flaggedComment.isAnnotation>
                <@s.url id="flagURL" namespace="/" action="manageAnnotationLoad" annotationId="${flaggedComment.target}"/>
              ...
              <#elseif flaggedComment.isRating>
                <@s.url id="flagURL" namespace="/" action="viewRating" ratingId="${flaggedComment.target}"/>
                <#assign deleteLabel = "Delete Rating">
              <#elseif flaggedComment.isReply>
                <@s.url id="flagURL" namespace="/" action="viewReply" replyId="${flaggedComment.target}"/>
