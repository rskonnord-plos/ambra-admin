 ...
 */
public class AdminUserProfileAction extends BaseSessionAwareActionSupport {
  private static final Logger log = LoggerFactory.getLogger(AdminUserProfileAction.class);
